...
Engine made by Packmanager9 and customized by ussaohelcim.
 */
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    class Rectangle {
        ...
        /**
         * Movimenta de acordo ao xmon/ymon
         */
        move() {
            this.x += this.xmom
            this.y += this.ymom
    ...
    function controlWasd(object, speed = 1) { // basic control for objects
    ...
    function controlJkli(object, speed = 1) { // basic control for objects
        if (typeof object.body != 'undefined') {
            if (keysPressed['i']) {
                object.body.y -= speed
            }
